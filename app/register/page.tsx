    ...
    try {
      ...
      if (data.user) {
        if (data.user.email_confirmed_at) {
          ...
          setSuccess("Conta criada com sucesso! agora so fazer login.")
          router.push("/login")
        }
      }
    } catch (err) {
            ...
            >
              ...
              <div className="flex justify-between items-center mb-8">
                <div className="flex gap-6">
                  <Link href="/login" className="hover:opacity-80" style={{ color: "var(--color-TertiaryText)" }}>
                    Entrar
                  </Link>
                  <span
                    className="text-2xl font-normal border-b-2 pb-1"
                    style={{ color: "var(--color-PrimaryText)", borderColor: "var(--color-TextLink)" }}
                  >
                    Registre-se
                  </span>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {success && (
                  <div
                    className="px-4 py-3 rounded-lg text-sm border"
                    style={{
                      backgroundColor: "var(--color-SuccessBg)",
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs mt-2" style={{ color: "var(--color-TertiaryText)" }}>
                    Não é possível alterar o e-mail no futuro. Ao especificar um e-mail inexistente ou incorreto, a
                    retirada de fundos da conta será impossível.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  />
                  <label htmlFor="acceptTerms" className="text-sm" style={{ color: "var(--color-PrimaryText)" }}>
                    Aceito os{" "}
                    <Link href="/terms" className="hover:opacity-80" style={{ color: "var(--color-TextLink)" }}>
                      termos de uso do {platformConfig.platform_name}
                    </Link>
                  </label>
                </div>
