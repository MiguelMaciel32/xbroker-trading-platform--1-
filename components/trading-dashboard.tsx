...
//   return <div ref={containerRef} className="w-full h-full" style={{ backgroundColor: "#181A20" }} />
// }
...
//               </div>
//               <div>
//                 <div className="text-white font-semibold text-sm lg:text-base">{selectedAsset.name}</div>
//                 <div className="text-gray-400 text-xs lg:text-sm">{selectedAsset.symbol}</div>
//               </div>
//             </div>
//             <span className="text-green-400 font-bold text-sm lg:text-base">{selectedAsset.payout}%</span>
//           </div>

//           <div className="rounded p-3" style={{ backgroundColor: "#181A20" }}>
//             <div className="text-gray-400 text-sm mb-2">Tempo</div>
//             <div className="grid grid-cols-6 lg:grid-cols-3 gap-1 lg:gap-2 mb-3">
//               {TIME_OPTIONS.map((time) => (
//                 <Button
//                   key={time}
//                   variant={selectedTime === time ? "default" : "ghost"}
//                   size="sm"
//                   className={`text-xs ${selectedTime === time ? "bg-yellow-500 text-black" : "text-white hover:bg-gray-700"} px-2 py-1`}
...
//               className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-600 py-3 lg:py-4 text-base lg:text-lg font-semibold flex items-center justify-center gap-2"
//             >
...
//               disabled={balance < tradeAmount}
//               className="w-full bg-red-600 hover:bg-red-700 disabled:bg-gray-600 py-3 lg:py-4 text-base lg:text-lg font-semibold flex items-center justify-center gap-2"
//             >
